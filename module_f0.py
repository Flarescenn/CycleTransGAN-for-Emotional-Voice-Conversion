...
class generator_gatedcnn(nn.Module):
    def __init__(self, input_channels=1):
        ...
        self.residual3 = residual1d_block(1024, filters=1024, kernel_size=3, strides=1)
        self.residual4 = residual1d_block(1024, filters=1024, kernel_size=3, strides=1)
        self.residual5 = residual1d_block(1024, filters=1024, kernel_size=3, strides=1)
        self.residual6 = residual1d_block(1024, filters=1024, kernel_size=3, strides=1)
        ...
        self.output_conv = conv1d_layer(512, filters=10, kernel_size=15, strides=1, activation=True)
...
class _discriminator(nn.Module):
    def __init__(self, inputs):
        ...
        self.expand_dims = lambda x: x.unsqueeze(-1)
...
class discriminator(nn.Module):
    def __init__(self, inputs):
        ...
        self.h1_conv = conv1d_layer(inputs, filters=64, kernel_size=3, strides=1, activation=nn.LeakyReLU())
        self.h1_conv_gates = conv1d_layer(inputs, filters=64, kernel_size=3, strides=1, activation=nn.LeakyReLU())
        ...
        self.downsample3 = downsample1d_block(256, filters=512, kernel_size=6, strides=2)
        
        # Final dense layer
        self.output_dense = nn.Linear(512, 1)  
